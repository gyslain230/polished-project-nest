        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in">
            <p className="text-lg mb-6">
              I am a passionate developer with over 5 years of experience building web applications. 
              My journey began with HTML, CSS, and JavaScript, and has evolved to include modern frameworks 
              like React, Node.js, and cloud technologies.
            </p>
            <p className="text-lg mb-6">
              When I'm not coding, I enjoy contributing to open source projects, writing technical articles, 
              and mentoring aspiring developers. I believe in continuous learning and staying updated with 
          ...
          <div className="animate-slide-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
              {["JavaScript", "React", "Node.js", "TypeScript", "MongoDB", "TailwindCSS"].map((skill) => (
                <div 
                  key={skill}
